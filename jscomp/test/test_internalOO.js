...
function for_all$1(p, _param) {
  while(true) {
    var param = _param;
    if (param) {
      if (Curry._2(p, param.v, param.d) && for_all$1(p, param.l)) {
        _param = param.r;
        continue ;
      } else {
        return false;
...
function exists$1(p, _param) {
  while(true) {
    var param = _param;
    if (param) {
      if (Curry._2(p, param.v, param.d) || exists$1(p, param.l)) {
        return true;
      } else {
        _param = param.r;
        continue ;
...
function map$2(f, param) {
  if (param) {
    var l$prime = map$2(f, param.l);
    var d$prime = Curry._1(f, param.d);
    var r$prime = map$2(f, param.r);
    return /* Node */[
            /* l */l$prime,
            /* v */param.v,
            /* d */d$prime,
...
function for_all$2(p, _param) {
  while(true) {
    var param = _param;
    if (param) {
      if (Curry._2(p, param.v, param.d) && for_all$2(p, param.l)) {
        _param = param.r;
        continue ;
      } else {
        return false;
...
function exists$2(p, _param) {
  while(true) {
    var param = _param;
    if (param) {
      if (Curry._2(p, param.v, param.d) || exists$2(p, param.l)) {
        return true;
      } else {
        _param = param.r;
        continue ;
